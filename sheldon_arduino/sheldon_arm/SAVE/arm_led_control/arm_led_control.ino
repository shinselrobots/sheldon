...
void loop() {
  ...
  // colorTest(50,0,0,50); // Red

  //colorTest(WHITE_LEVEL, WHITE_LEVEL, WHITE_LEVEL, 50); // White
  BluePulse(WHITE_LEVEL, WHITE_LEVEL, WHITE_LEVEL, 5); // White

  randNumber = random(100, 1200);
