...
void loop(void)
{
  ...
  if (Android.Connected)
  {
      ...
      if (13 == Android.Cmd) {
        ...
        switch (Android.Cmd) {
          ...
          case 5:
            ...
            break;
          case 6:
            behavior_cmd_msg.commandState = "PY_TELL_A_JOKE";
            break;
          case 7:
          ...
          case 8:
            ...
            break;
          case 9:
            behavior_cmd_msg.commandState = "SHIP"; // "TEST_JOINTS"; // "HAVE_SOMETHING";
            break;
          case 10:
            behavior_cmd_msg.commandState = "MOVE"; // "PUT_AWAY";
            behavior_cmd_msg.param1 = "0.3048"; // amount in meters
            behavior_cmd_msg.param2 = "0.2"; // speed 
            break;
          case 11:
            behavior_cmd_msg.commandState = "TURN"; // "CLEAN_UP";
            behavior_cmd_msg.param1 = "45.0"; // amount in degrees
            behavior_cmd_msg.param2 = "0.2"; // speed 
            break;
          case 12:
          ...
          case 14:
            ...
            break;
          case 15:
            behavior_cmd_msg.commandState = "BOW_GREETING";
            break;
    ...
    if (Android.AccEnabled ) {     // && Android.UpdatePending)
      ...
      bt_motor_cmd_msg.header.stamp = nh.now();
      pub_bluetooth_motor_cmd.publish(&bt_motor_cmd_msg);
      debugString = String("DBG: BlueTooth Pitch: ") + String(Android.Pitch) + String(" Roll: ") + String(Android.Roll);
      debugString.toCharArray(debugStringChar, DEBUG_STRING_LEN );
      nh.loginfo(debugStringChar);
  ...
  if ( TimeToPublishStatus() ) {
    ...
    // TODO - should publish rate be limited to TimeToPublishStatus ?
