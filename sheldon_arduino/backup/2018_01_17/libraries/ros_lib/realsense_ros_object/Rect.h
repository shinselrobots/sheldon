#ifndef _ROS_realsense_ros_object_Rect_h
#define _ROS_realsense_ros_object_Rect_h
...
namespace realsense_ros_object
{
  ...
  class Rect : public ros::Msg
  {
    ...
    const char * getType(){ return "realsense_ros_object/Rect"; };
    const char * getMD5(){ return "77cbce8086047f00755fff9fa950d785"; };
