...
void loop(void)
{
      ...
      if (13 == Android.Cmd) {
        ...
        switch (Android.Cmd) {
          ...
          case 9:
            ...
            break;
          case 10:
            behavior_cmd_msg.commandState = "PUT_AWAY";
            break;
          case 11:
            behavior_cmd_msg.commandState = "CLEAN_UP";
            break;
          case 12:
  ...
  if ( TimeToPublishStatus() ) {
    ...
    // Publish Compass value - TODO - should publish rate be limited to TimeToPublishStatus ?
    compassMsg.data = lastCompass++; // TODO - replace this test with real data!
