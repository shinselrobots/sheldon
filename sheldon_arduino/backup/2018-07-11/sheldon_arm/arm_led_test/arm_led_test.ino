...
void setup() {
  ...
  Serial.begin(9600);
  Serial.println("Starting NeoPixel Test...");
...
void loop() {
  ...
  digitalWrite(LED_BUILTIN, HIGH);
  colorWipe(strip.Color(WHITE_LEVEL, WHITE_LEVEL, WHITE_LEVEL), 5); // White
  delay(1000);
  
  digitalWrite(LED_BUILTIN, LOW);
  colorWipe(strip.Color(RED_LEVEL, 0, 0), 5); // Red
  delay(1000);
  
  digitalWrite(LED_BUILTIN, HIGH);
  colorWipe(strip.Color(0, GREEN_LEVEL, 0), 5); // Green
  delay(1000);
  
  digitalWrite(LED_BUILTIN, LOW);
  colorWipe(strip.Color(0, 0, BLUE_LEVEL), 5); // Blue
  delay(1000);
