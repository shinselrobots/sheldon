#ifndef _ROS_cob_object_detection_msgs_Mask_h
#define _ROS_cob_object_detection_msgs_Mask_h
...
namespace cob_object_detection_msgs
{
  ...
  {
    public:
      typedef cob_object_detection_msgs::Rect _roi_type;
      _roi_type roi;
    ...
    const char * getType(){ return "cob_object_detection_msgs/Mask"; };
