...
def right_arm_down():
    ...
    #pub_right_arm_shoulder_lift.publish(0.25) # keep away from body
    pub_right_arm_shoulder_rotate.publish(-0.4)
...
def left_arm_down():
    ...
    pub_left_arm_shoulder_lift.publish(0.25) # keep away from body
    pub_left_arm_shoulder_rotate.publish(-0.4)
    left_claw_open_half()
...
def left_arm_write_ready():
    ...
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin)
...
def left_arm_draw_left_eye():
    ...
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin - y_line)
    time.sleep(sleep_time)

    pub_left_arm_elbow_bend.publish(1.57 + 0.00)
    time.sleep(sleep_time)

    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin - 0.00)
    time.sleep(sleep_time)
...
def left_arm_draw_right_eye():
    ...
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin-(0.00 + eye_offset))
    time.sleep(1.5)
    ...
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin-(y_line + eye_offset))
    time.sleep(sleep_time)
...
def left_arm_draw_mouth():
    ...
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin+0.05) # start to the left of the eye
    time.sleep(2.5)
    ...
    time.sleep(0.4)
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin-0.20) # draw continuous line to the right
...
def draw_smiley():
    ...
    pub_left_arm_shoulder_lift.publish(g_left_draw_lift_origin+0.0)
    pub_left_arm_elbow_rotate.publish(0.0)
...
def left_arm_wave():
    ...
    pub_left_arm_wrist_rotate.publish(0.0)
    #pub_left_arm_claw.publish(0.8)
    pub_left_arm_shoulder_rotate.publish(1.7)
    time.sleep(2.5)
...
# RIGHT ARM
        ...
        right_arm_extend() # give item (claw stays)
    elif key == '14':
...
# LEFT ARM
        ...
        left_arm_extend() # give item (claw stays)
    elif key == '24':
